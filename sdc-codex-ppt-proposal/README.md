...
핵심 메시지:
AI 도구 하나를 더 쓰는 것이 아니라, 반복 산출물이 만들어지고 검수되는 작업 환경을 만든다.

말투:
임직원 교육용으로 명확하고 실무적으로 설명한다. 과장된 혁신 문구보다 업무시간 절감, 검수 가능성, 보안선 준수를 강조한다.
```
